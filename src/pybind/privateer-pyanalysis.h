    ...
    class GlycanStructure 
    {
      public:
        ...
        GlycanStructure(const clipper::MGlycology& mgl, const int glycanID, privateer::pyanalysis::GlycosylationComposition& parentGlycosylationComposition){
          this->updatedWithExperimentalData = false;
          this->pyinit_withparent ( mgl, glycanID, parentGlycosylationComposition );
        };
        ...
        ~GlycanStructure() { };
        void pyinit_withparent ( const clipper::MGlycology& mgl, const int glycanID, privateer::pyanalysis::GlycosylationComposition& parentGlycosylationComposition);
