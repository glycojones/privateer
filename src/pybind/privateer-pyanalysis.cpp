...
privateer::pyanalysis::GlycosylationComposition::GlycosylationComposition(std::string& path_to_model_file, std::string expression_system, bool disable_torsions, bool debug_output)
{
    this->debug_output = debug_output;
    this->read_from_file ( path_to_model_file, expression_system, disable_torsions, debug_output );
};
...
void privateer::pyanalysis::GlycanStructure::pyinit_withparent( const clipper::MGlycology& mgl, const int glycanID, privateer::pyanalysis::GlycosylationComposition& parentGlycosylationComposition)
{
