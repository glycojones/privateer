...
class PrivateerTool(ToolInstance):
    ...
    def __init__(self, session, tool_name):
        ...
        self.display_name = "Privateer - Validate Carbohydrates"
    ...
    def _build_ui(self):
        ...
        layout = QHBoxLayout()
        layout.addWidget(QLabel("Output Folder Path:"))
    ...
    def return_pressed(self):
        ...
        run(self.session, f"privateer_validation {self.line_edit.text()}") #Change this to the inputs to run my privateer command
