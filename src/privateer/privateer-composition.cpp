...
// push to local vector associated with monomers regarding their anomer permutations that is created in thread
// recombine after loop is finished with main result vector
