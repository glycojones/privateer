...
const sugar_database_entry sugar_database[] =
{
    ...
    { "AOG" ,	 "B", 	 "D", 	 "hexyl 3-amino-3-deoxy-beta-D-galactopyranoside" , "O5 C1 C2 C3 C4 C5", 0.623, "4c1", 0.003, 2.051 },
    ...
    std::string convert_to_wurcs_residue_code( std::string name )
    {
        ...
        else if ( name == "SGC" ) wurcs_residue_code = "a2122h-1b_1-5";
        ...
        else if ( name == "Z3Q" ) wurcs_residue_code = "a2122h-1b_1-5_1*OCCN=^EN=N_2*NCC/3=O";
        ...
        else if ( name == "U2A" ) wurcs_residue_code = "a2122h-1b_1-5_1*OC";
        else if ( name == "U1Y" ) wurcs_residue_code = "a2122h-1b_1-5_1*OC";
