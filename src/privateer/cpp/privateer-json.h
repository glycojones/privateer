...
// All credits for the implementation of this json library into Privateer go to Marcin Wojdyr(https://github.com/wojdyr) and chadaustin/sajson(https://github.com/chadaustin/sajson)
