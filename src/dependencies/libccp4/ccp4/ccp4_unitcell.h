 ...
 * @return Cell volume
 */
CCP4_IMEX double ccp4uc_frac_orth_mat(const double cell[6], const int ncode,
 ...
 */
CCP4_IMEX double ccp4uc_calc_rcell(const double cell[6], double rcell[6]);
 ...
 * @return void
 */
CCP4_IMEX void ccp4uc_orth_to_frac(const double rf[3][3], const double xo[3], double xf[3]);
 ...
 * @return void
 */
CCP4_IMEX void ccp4uc_frac_to_orth(const double ro[3][3], const double xf[3], double xo[3]);
 ...
 * @return void
 */
CCP4_IMEX void ccp4uc_orthu_to_fracu(const double rf[3][3], const double uo[6], double uf[6]);
 ...
 * @return void
 */
CCP4_IMEX void ccp4uc_fracu_to_orthu(const double ro[3][3], const double uf[6], double uo[6]);

/** Calculate cell volume from cell parameters.
 * @param cell
 * @return Cell volume.
 */
CCP4_IMEX double ccp4uc_calc_cell_volume(const double cell[6]);
 ...
 */
CCP4_IMEX int ccp4uc_cells_differ(const double cell1[6], const double cell2[6], const double tolerance);
 ...
 */
CCP4_IMEX int ccp4uc_is_rhombohedral(const float cell[6], const float tolerance);
 ...
 * @return 1 if cell parameters conform, 0 otherwise.
 */
CCP4_IMEX int ccp4uc_is_hexagonal(const float cell[6], const float tolerance);
