 ...
 */
CCP4_IMEX CCP4PARSERARRAY* ccp4_parse_start(const int maxtokens);
 ...
 */
CCP4_IMEX int ccp4_parse_end(CCP4PARSERARRAY *parsePtr);

CCP4_IMEX int ccp4_parse_init_token(const CCP4PARSERARRAY *parsePtr, const int itok);

CCP4_IMEX int ccp4_parse_delimiters(CCP4PARSERARRAY *parsePtr, const char *delim,
				  const char *nulldelim);

CCP4_IMEX int ccp4_parse_comments(CCP4PARSERARRAY *parsePtr, const char *comment_chars);

CCP4_IMEX int ccp4_parse_maxmin(CCP4PARSERARRAY *parsePtr, const double max_exponent,
			      const double min_exponent);

CCP4_IMEX int ccp4_parse_reset(CCP4PARSERARRAY *parsePtr);

CCP4_IMEX int ccp4_parse(const char *line, CCP4PARSERARRAY *parser);
 ...
 */
CCP4_IMEX int ccp4_parser(char *line, const int n, CCP4PARSERARRAY *parser,
			const int print);
 ...
 */
CCP4_IMEX int ccp4_keymatch(const char *keyin1, const char *keyin2);
 ...
 * @return str1
 */
CCP4_IMEX char *strtoupper (char *str1, const char *str2);
 ...
 * @return str1
 */
CCP4_IMEX char *strtolower (char *str1, const char *str2);

CCP4_IMEX int strmatch (const char *str1, const char *str2);

CCP4_IMEX int charmatch(const char character, const char *charlist);

CCP4_IMEX int doublefromstr(const char *str, const double max_exp, const double min_exp,
 ...
 */
CCP4_IMEX ccp4_symop symop_to_rotandtrn(const char *symchs_begin, const char *symchs_end);
 ...
 */
CCP4_IMEX const char * symop_to_mat4(const char *symchs_begin, const char *symchs_end, float *rot);
CCP4_IMEX int symop_to_mat4_err(const char *symop);
ccp4_symop mat4_to_rotandtrn(const float rsm[4][4]);
/* This is Charles' version of symtr */
CCP4_IMEX char *rotandtrn_to_symop(char *symchs_begin, char *symchs_end, const ccp4_symop symop);
CCP4_IMEX void rotandtrn_to_mat4(float rsm[4][4], const ccp4_symop symop);
 ...
 */
CCP4_IMEX char *mat4_to_symop(char *symchs_begin, char *symchs_end, const float rsm[4][4]);
 ...
 * @return pointer to beginning of string
 */
CCP4_IMEX char *mat4_to_recip_symop(char *symchs_begin, char *symchs_end, const float rsm[4][4]);
