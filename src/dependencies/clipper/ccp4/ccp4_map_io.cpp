...
// xmap import
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<unsigned char>( Xmap<unsigned char>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<char>( Xmap<char>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<unsigned short>( Xmap<unsigned short>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<short>( Xmap<short>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<unsigned int>( Xmap<unsigned int>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<int>( Xmap<int>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<ftype32>( Xmap<ftype32>& xmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_xmap<ftype64>( Xmap<ftype64>& xmap ) const;
// xmap export
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<unsigned char>( const Xmap<unsigned char>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<char>( const Xmap<char>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<unsigned short>( const Xmap<unsigned short>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<short>( const Xmap<short>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<unsigned int>( const Xmap<unsigned int>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<int>( const Xmap<int>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<ftype32>( const Xmap<ftype32>& xmap );
template CLIPPER_IMEX void CCP4MAPfile::export_xmap<ftype64>( const Xmap<ftype64>& xmap );
// nxmap import
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<unsigned char>( NXmap<unsigned char>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<char>( NXmap<char>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<unsigned short>( NXmap<unsigned short>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<short>( NXmap<short>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<unsigned int>( NXmap<unsigned int>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<int>( NXmap<int>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<ftype32>( NXmap<ftype32>& nxmap ) const;
template CLIPPER_IMEX void CCP4MAPfile::import_nxmap<ftype64>( NXmap<ftype64>& nxmap ) const;
// nxmap export
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<unsigned char>( const NXmap<unsigned char>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<char>( const NXmap<char>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<unsigned short>( const NXmap<unsigned short>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<short>( const NXmap<short>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<unsigned int>( const NXmap<unsigned int>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<int>( const NXmap<int>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<ftype32>( const NXmap<ftype32>& nxmap );
template CLIPPER_IMEX void CCP4MAPfile::export_nxmap<ftype64>( const NXmap<ftype64>& nxmap );
// xmap import and check
template CLIPPER_IMEX CCP4MAPfile::ASUerror CCP4MAPfile::import_xmap_check_asu<ftype32>( Xmap<ftype32>& xmap, ftype32 missing ) const;
template CLIPPER_IMEX CCP4MAPfile::ASUerror CCP4MAPfile::import_xmap_check_asu<ftype64>( Xmap<ftype64>& xmap, ftype64 missing ) const;
