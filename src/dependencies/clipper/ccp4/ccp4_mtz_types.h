...
namespace clipper
{
  ...
  //! CCP4 crystal object
  class CLIPPER_IMEX MTZcrystal : public Cell
  {
  public:
    //! null constructor
    MTZcrystal() {}
  ...
  /*!
    ...
    mtz++ crystal element.
  */
  class CLIPPER_IMEX CMTZcrystal : public Container, public MTZcrystal
  {
  public:
    //! null constructor
    CMTZcrystal() {}
  ...
  /*!
    ...
    mtz++ dataset element.
  */
  class CLIPPER_IMEX CMTZdataset : public Container, public MTZdataset
  {
  public:
    //! null constructor
    CMTZdataset() {}
