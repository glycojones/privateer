 ...
 */
CCP4_IMEX MTZ *MtzGet(const char *logname, int read_refs);
 ...
 * @return Pointer to MTZ struct
 */
CCP4_IMEX MTZ *MtzGetUserCellTolerance(const char *logname, int read_refs, const double cell_tolerance);
 ...
 */
CCP4_IMEX int MtzRrefl(CCP4File *filein, int ncol, float *refldata);
 ...
 */
CCP4_IMEX int MtzPut(MTZ *mtz, const char *logname);
 ...
 */
CCP4_IMEX CCP4File *MtzOpenForWrite(const char *logname);
 ...
 */
CCP4_IMEX int MtzWhdrLine(CCP4File *fileout, int nitems, char buffer[]);
 ...
 */
CCP4_IMEX int MtzWrefl(CCP4File *fileout, int ncol, float *refldata);
 ...
 * @return void
 */
CCP4_IMEX void MtzMemTidy(void);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzResLimits(const MTZ *mtz, float *minres, float *maxres);
 ...
 */
CCP4_IMEX int MtzNxtal(const MTZ *mtz);

/** Get the number of active crystals in the MTZ structure
 * @param mtz pointer to MTZ struct
 * @return number of active crystals
 */
CCP4_IMEX int MtzNumActiveXtal(const MTZ *mtz);

/** Return array of pointers to crystals.
 * @param mtz pointer to MTZ struct
 * @return array of pointers to crystals
 */
CCP4_IMEX MTZXTAL **MtzXtals(MTZ *mtz);
 ...
 */
CCP4_IMEX MTZXTAL *MtzIxtal(const MTZ *mtz, const int ixtal);
 ...
 */
CCP4_IMEX char *MtzXtalPath(const MTZXTAL *xtal);
 ...
 */
CCP4_IMEX MTZXTAL *MtzXtalLookup(const MTZ *mtz, const char *label);
 ...
 * @return Pointer to crystal.
 */
CCP4_IMEX MTZXTAL *MtzAddXtal(MTZ *mtz, const char *xname, const char *pname,
                  const float cell[6]);
 ...
 */
CCP4_IMEX int MtzNsetsInXtal(const MTZXTAL *xtal);

/** For a given crystal, return number of active datasets in that crystal.
 * @param xtal pointer to the crystal struct
 * @return number of datasets
 */
CCP4_IMEX int MtzNumActiveSetsInXtal(const MTZ *mtz, const MTZXTAL *xtal);
 ...
 */
CCP4_IMEX MTZSET **MtzSetsInXtal(MTZXTAL *xtal);
 ...
 */
CCP4_IMEX MTZSET *MtzIsetInXtal(const MTZXTAL *xtal, const int iset);
 ...
 */
CCP4_IMEX int MtzNset(const MTZ *mtz);

/** Get the number of active datasets in the MTZ structure
 * @param mtz pointer to MTZ struct
 * @return total number of datasets
 */
CCP4_IMEX int MtzNumActiveSet(const MTZ *mtz);
 ...
 *    not present in "mtz".
 */
CCP4_IMEX MTZXTAL *MtzSetXtal(const MTZ *mtz, const MTZSET *set);
 ...
 * @return pointer to string containing path name
 */
CCP4_IMEX char *MtzSetPath(const MTZ *mtz, const MTZSET *set);
 ...
 */
CCP4_IMEX MTZSET *MtzSetLookup(const MTZ *mtz, const char *label);
 ...
 */
CCP4_IMEX MTZSET *MtzAddDataset(MTZ *mtz, MTZXTAL *xtl, const char *dname,
 ...
 */
CCP4_IMEX int MtzNumSourceColsInSet(const MTZSET *set);
 ...
 * @return number of batches
 */
CCP4_IMEX int MtzNbatchesInSet(const MTZ *mtz, const MTZSET *set);
 ...
 */
CCP4_IMEX MTZCOL **MtzColsInSet(MTZSET *set);
 ...
 */
CCP4_IMEX MTZCOL *MtzIcolInSet(const MTZSET *set, const int icol);
 ...
 */
CCP4_IMEX MTZCOL *MtzAddColumn(MTZ *mtz, MTZSET *set, const char *label,
                   const char *type);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzAssignHKLtoBase(MTZ *mtz);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzAssignColumn(MTZ *mtz, MTZCOL *col, const char crystal_name[],
 ...
 */
CCP4_IMEX int MtzToggleColumn(MTZCOL *col);
 ...
 */
CCP4_IMEX MTZSET  *MtzColSet(const MTZ *mtz, const MTZCOL *col);

/** Get the number of columns in the MTZ data structure.
 * @param mtz pointer to MTZ struct
 * @return number of columns
 */
CCP4_IMEX int MtzNcol(const MTZ *mtz);

/** Get the number of active columns in the MTZ data structure.
 * @param mtz pointer to MTZ struct
 * @return number of columns
 */
CCP4_IMEX int MtzNumActiveCol(const MTZ *mtz);
 ...
 * @return number of columns
 */
CCP4_IMEX int MtzNumSourceCol(const MTZ *mtz);
 ...
 */
CCP4_IMEX char *MtzColPath(const MTZ *mtz, const MTZCOL *col);
 ...
 * @return 1 on success, 0 on failure.
 */
CCP4_IMEX int MtzRJustPath(char *path, const char *partial, const int njust);
 ...
 */
CCP4_IMEX int MtzPathMatch(const char *path1, const char *path2);
 ...
 * @return pointer to column
 */
CCP4_IMEX MTZCOL *MtzColLookup(const MTZ *mtz, const char *label);

/** Get the MTZ column type of a particular column.
 * @param col pointer to MTZ column.
 * @return column type
 */
CCP4_IMEX char *MtzColType(MTZCOL *col);
 ...
 * @return void
 */
CCP4_IMEX void MtzDebugHierarchy(const MTZ *mtz);
 ...
 */
CCP4_IMEX int MtzListColumn(const MTZ *mtz, char clabs[][31], char ctyps[][3], int csetid[]);
 ...
 */
CCP4_IMEX int MtzListInputColumn(const MTZ *mtz, char clabs[][31], char ctyps[][3], int csetid[]);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzFindInd(const MTZ *mtz, int *ind_xtal, int *ind_set, int ind_col[3]);
 ...
 * @return resolution
 */
CCP4_IMEX float MtzInd2reso(const int in[3], const double coefhkl[6]);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzHklcoeffs(const float cell[6], double coefhkl[6]);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzArrayToBatch(const int *intbuf, const float *fltbuf, MTZBAT *batch);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzBatchToArray(MTZBAT *batch, int *intbuf, float *fltbuf);
 ...
 *  already in order
 */
CCP4_IMEX MTZBAT *sort_batches(MTZBAT *batch, int numbat);
 ...
 *  character.
 */
CCP4_IMEX int ccp4_lrtitl(const MTZ *mtz, char *title);
 ...
 */
CCP4_IMEX int ccp4_lrhist(const MTZ *mtz, char history[][MTZRECORDLENGTH], int nlines);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lrsort(const MTZ *mtz, int isort[5]);
 ...
 * @return Number of batches.
 */
CCP4_IMEX int ccp4_lrbats(const MTZ *mtz, int *nbatx, int batchx[]);
 ...
 * @return 1 on success, 0 on failure.
 */
CCP4_IMEX int ccp4_lrcell(const MTZXTAL *xtl, float cell[]);
 ...
 * @return Spacegroup number.
 */
CCP4_IMEX int ccp4_lrsymi(const MTZ *mtz, int *nsympx, char *ltypex, int *nspgrx,
 ...
 * @return Spacegroup number.
 */
CCP4_IMEX int ccp4_lrsymi_c(const MTZ *mtz, int *nsympx, char *ltypex, int *nspgrx,
 ...
 */
CCP4_IMEX int ccp4_lrsymm(const MTZ *mtz, int *nsymx, float rsymx[192][4][4]);
 ...
 */
CCP4_IMEX int MtzParseLabin(char *labin_line, const char prog_labels[][31],
 ...
 */
CCP4_IMEX MTZCOL **ccp4_lrassn(const MTZ *mtz, const char labels[][31], const int nlabels,
		char types[][3]);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lridx(const MTZ *mtz, const MTZSET *set, char crystal_name[64],
 ...
 */
CCP4_IMEX int ccp4_lrrefl(const MTZ *mtz, float *resol, float adata[], int logmss[], int iref);
 ...
 * @return 1 if past last reflection, else 0
 */
CCP4_IMEX int ccp4_lrreff(const MTZ *mtz, float *resol, float adata[], int logmss[],
 ...
 */
CCP4_IMEX int ccp4_ismnf(const MTZ *mtz, const float datum);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lhprt(const MTZ *mtz, int iprint);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lhprt_adv(const MTZ *mtz, int iprint);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lrbat(MTZBAT *batch, float *buf, char *charbuf, int iprint);

/** Function to print batch header data for a specified batch to stdout.
 * @param batch Pointer to requested batch.
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzPrintBatchHeader(const MTZBAT *batch);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwtitl(MTZ *mtz, const char *ftitle, int flag);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int MtzSetSortOrder(MTZ *mtz, MTZCOL *colsort[5]);
 ...
 */
CCP4_IMEX int MtzAddHistory(MTZ *mtz, const char history[][MTZRECORDLENGTH], const int nlines);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwsymm(MTZ *mtz, int nsymx, int nsympx, float rsymx[192][4][4],
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwsymm_c(MTZ *mtz, int nsymx, int nsympx, float rsymx[192][4][4],
		  char ltypex[], int nspgrx, char spgrnx[], char pgnamx[],
                  char spgconf[]);
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwsymconf(MTZ *mtz, char spgconf[]);
 ...
 */
CCP4_IMEX MTZCOL **ccp4_lwassn(MTZ *mtz, const char labels[][31], const int nlabels,
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwidx(MTZ *mtz, const char crystal_name[],  const char dataset_name[],
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwrefl(MTZ *mtz, const float adata[], MTZCOL *lookup[],
 ...
 * @return 1 on success, 0 on failure
 */
CCP4_IMEX int ccp4_lwbat(MTZ *mtz, MTZBAT *batch, const int batno, const float *buf, const char *charbuf);

CCP4_IMEX int ccp4_lwbsetid(MTZ *mtz, MTZBAT *batch, const char xname[], const char dname[]);
