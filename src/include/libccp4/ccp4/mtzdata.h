...
/** MTZ column struct. */
typedef struct CCP4_IMEX { char label[31];       /**< column name as given by user */
...
/** MTZ dataset struct. */
typedef struct CCP4_IMEX { int setid;            /**< Dataset id */
...
/** MTZ crystal struct. */
typedef struct CCP4_IMEX { int xtalid;           /**< Crystal id */
