 ...
 */
CCP4_IMEX CCP4SPG *ccp4spg_load_by_standard_num(const int numspg);
 ...
 * @return pointer to spacegroup
 */
CCP4_IMEX CCP4SPG *ccp4spg_load_by_ccp4_num(const int ccp4numspg);
 ...
 * @return pointer to spacegroup
 */
CCP4_IMEX CCP4SPG *ccp4spg_load_by_spgname(const char *spgname);
 ...
 * @return pointer to spacegroup
 */
CCP4_IMEX CCP4SPG *ccp4spg_load_by_ccp4_spgname(const char *ccp4spgname);
 ...
 * @return pointer to spacegroup
 */
CCP4_IMEX CCP4SPG * ccp4_spgrp_reverse_lookup(const int nsym1, const ccp4_symop *op1);
 ...
 * @return pointer to spacegroup
 */
CCP4_IMEX CCP4SPG *ccp4spg_load_spacegroup(const int numspg, const int ccp4numspg,
 ...
 */
CCP4_IMEX void ccp4spg_mem_tidy(void);
 ...
 */
CCP4_IMEX int symfr_driver (const char *line, float rot[][4][4]);

/** Free memory associated with spacegroup.
 * @param sp pointer to spacegroup
 */
CCP4_IMEX void ccp4spg_free(CCP4SPG **sp);
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_register_by_ccp4_num(int numspg);
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_register_by_symops(int nops, float rsm[][4][4]);
 ...
 */
CCP4_IMEX int ccp4_spg_get_centering(const char *symbol_Hall, float cent_ops[4][3]);
 ...
 */
CCP4_IMEX int ccp4spg_load_laue(CCP4SPG* spacegroup, const int nlaue);

/** Test if reflection is in asu of Laue group 1bar.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_1b   (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 2/m.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_2_m  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group mmm.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_mmm  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 4/m.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_4_m  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 4/mmm.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_4_mmm(const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 3bar.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_3b   (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 3bar1m.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_3bm  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 3barm.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_3bmx (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 6/m.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_6_m  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group 6/mmm.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_6_mmm(const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group m3bar.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_m3b  (const int h, const int k, const int l);

/** Test if reflection is in asu of Laue group m3barm.
 * @return 1 if in asu else 0
 */
CCP4_IMEX int ASU_m3bm  (const int h, const int k, const int l);

/** Function to return Hall symbol for spacegroup.
 * @param sp pointer to spacegroup
 * @return pointer to Hall symbol for spacegroup
 */
CCP4_IMEX char *ccp4spg_symbol_Hall(CCP4SPG* sp);
 ...
 */
CCP4_IMEX ccp4_symop ccp4_symop_invert( const ccp4_symop op1 );
...
*/
CCP4_IMEX int ccp4spg_name_equal(const char *spgname1, const char *spgname2);
 ...
 * @return 1 if they are equal else 0.
*/
CCP4_IMEX int ccp4spg_name_equal_to_lib(const char *spgname_lib, const char *spgname_match);
...
*/
CCP4_IMEX char *ccp4spg_to_shortname(char *shortname, const char *longname);
 ...
 * @return void
*/
CCP4_IMEX void ccp4spg_name_de_colon(char *name);
 ...
 * @return 1 if they are equal else 0.
*/
CCP4_IMEX int ccp4spg_pgname_equal(const char *pgname1, const char *pgname2);
...
*/
CCP4_IMEX ccp4_symop *ccp4spg_norm_trans(ccp4_symop *op);
 ...
 * @return 1 if they are equal else 0.
*/
CCP4_IMEX int ccp4_spgrp_equal( int nsym1, const ccp4_symop *op1, int nsym2, const ccp4_symop *op2);
 ...
 * @return 1 if they are equal else 0.
*/
CCP4_IMEX int ccp4_spgrp_equal_order( int nsym1, const ccp4_symop *op1, int nsym2, const ccp4_symop *op2);
 ...
 * @return int code.
 */
CCP4_IMEX int ccp4_symop_code(ccp4_symop op);
...
*/
CCP4_IMEX int ccp4_int_compare( const void *p1, const void *p2 );
 ...
 */
CCP4_IMEX int ccp4spg_is_in_pm_asu(const CCP4SPG* sp, const int h, const int k, const int l);
 ...
 */
CCP4_IMEX int ccp4spg_is_in_asu(const CCP4SPG* sp, const int h, const int k, const int l);
 ...
 */
CCP4_IMEX int ccp4spg_put_in_asu(const CCP4SPG* sp, const int hin, const int kin, const int lin,
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_generate_indices(const CCP4SPG* sp, const int isym,
 ...
 */
CCP4_IMEX float ccp4spg_phase_shift(const int hin, const int kin, const int lin,
 ...
 */
CCP4_IMEX int ccp4spg_do_chb(const float chb[3][3]);
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_set_centric_zones(CCP4SPG* sp);
 ...
 *  an error.
 */
CCP4_IMEX int ccp4spg_is_centric(const CCP4SPG* sp, const int h, const int k, const int l);
 ...
 */
CCP4_IMEX int ccp4spg_check_centric_zone(const int nzone, const int h, const int k, const int l);
 ...
 */
CCP4_IMEX float ccp4spg_centric_phase(const CCP4SPG* sp, const int h, const int k, const int l);

/** Print a summary of the centric zones of a spacegroup.
 * @param sp pointer to spacegroup
 * @return void
 */
CCP4_IMEX void ccp4spg_print_centric_zones(const CCP4SPG* sp);
 ...
 */
CCP4_IMEX char *ccp4spg_describe_centric_zone(const int nzone, char *centric_zone);
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_set_epsilon_zones(CCP4SPG* sp);
 ...
 */
CCP4_IMEX int ccp4spg_get_multiplicity(const CCP4SPG* sp, const int h, const int k, const int l);
 ...
 * @return 0 if in zone "nzone", non-zero otherwise
 */
CCP4_IMEX int ccp4spg_check_epsilon_zone(const int nzone, const int h, const int k, const int l);

/** Print a summary of the epsilon zones of a spacegroup.
 * @param sp pointer to spacegroup
 * @return void
 */
CCP4_IMEX void ccp4spg_print_epsilon_zones(const CCP4SPG* sp);
 ...
 */
CCP4_IMEX char *ccp4spg_describe_epsilon_zone(const int nzone, char *epsilon_zone);
 ...
 */
CCP4_IMEX int ccp4spg_is_sysabs(const CCP4SPG* sp, const int h, const int k, const int l);
 ...
 */
CCP4_IMEX int ccp4spg_generate_origins(const char *namspg, const int nsym, const float rsym[][4][4],
 ...
 * @return void
 */
CCP4_IMEX void ccp4spg_print_recip_spgrp(const CCP4SPG* sp);

/** Print reciprocal symops.
 * @param sp pointer to spacegroup
 * @return void
 */
CCP4_IMEX void ccp4spg_print_recip_ops(const CCP4SPG* sp);
 ...
 * @return 0 on success
 */
CCP4_IMEX int range_to_limits(const char *range, float limits[2]);
 ...
 * @return void
 */
CCP4_IMEX void set_fft_grid(CCP4SPG* sp, const int nxmin, const int nymin, const int nzmin,
 ...
 */
CCP4_IMEX int all_factors_le_19(const int n);
 ...
 */
CCP4_IMEX int get_grid_sample(const int minsmp, const int nmul, const float sample);
 ...
 */
CCP4_IMEX int ccp4spg_check_symm_cell(int nsym, float rsym[][4][4], float cell[6]);
