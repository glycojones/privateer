...
void MAtom::set_id( const String& s, bool is_gemmi) { id_ = id_tidy( s, is_gemmi ); }

void MAtom::set_name( const String s, const String altconf, bool is_gemmi )
{
 if ( altconf != "" ) set_id( s + ":" + altconf, is_gemmi );
 else                 set_id( s, is_gemmi );
}

String MAtom::id_tidy( const String& id, bool is_gemmi )
{
 int pos = id.find( ":" );
