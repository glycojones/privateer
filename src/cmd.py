...
#from . import privateerwrapperfunctions as pvt
...
def privateer_validation(session,InputStructureFilePath,OutputFilePath):
    ...
    glycosylation = pvt.GlycosylationComposition(InputStructureFilePath)
...
def register_privateer_cmd(logger):
    validate_desc = CmdDesc(
        required=[
    ...
    register("privateer validate", validate_desc, privateer_validation, logger=logger)
