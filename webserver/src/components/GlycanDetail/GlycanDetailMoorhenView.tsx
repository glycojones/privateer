...
export function GlycanDetailMoorhenView(props: {
    ...
    return <div key={props.key} className="px-8 flex flex-col items-center">
        <h3 className="text-left text-xl w-full">Visualise with <i>Moorhen</i> <a href="https://moorhen.org"
                                                                                  title="Go to Moorhen.org"><img
            className="inline h-8" src="./moorhen_logo.png"></img></a></h3>
        ...
        <input id="contour-range" type="range" min="0" max="2" step="0.05" defaultValue="0.2"
               ...
               onChange={props.onChange} onMouseDown={(e) => {
            e.stopPropagation()
        }}
               onTouchStart={(e) => {
                   e.stopPropagation()
        ...
        <div className="mt-4">
            <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" className="sr-only peer" onMouseDown={(e) => {
                    e.stopPropagation()
                }}
                       onTouchStart={(e) => {
                           e.stopPropagation()
