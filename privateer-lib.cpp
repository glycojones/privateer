...
{
	output  << "; This script has been created by Privateer (Agirre and Cowtan, 2013-14)\n"	
...
void insert_coot_statusbar_text_scheme ( std::fstream& output, const clipper::String& text)
{
	output  << "(add-status-bar-text \"" << text << "\")" ; 
}

void insert_coot_statusbar_text_python ( std::fstream& output, const clipper::String& text)
{
