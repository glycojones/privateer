...
Languages: C++11 and Python2 (via pybind11), produces Scheme and Python scripts for use with Coot (https://github.com/pemsley/coot).

Dependencies: Gemmi (https://github.com/project-gemmi/gemmi), Pybind11 (https://github.com/pybind/pybind11), JSON for Modern C++ (https://github.com/nlohmann/json) CMake (version 3.12 minimum) and a few CCP4 LGPLv3-compatible development libraries.
