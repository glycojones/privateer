...
export const DatabaseColumns = [
    ...
    },
    {
        ...
        accessor: 'WURCS',
        Cell: tableProps => {
            return (<button className="justify-center" title="Copy WURCS to clipboard" onClick={(e) => { navigator.clipboard.writeText(tableProps.row.original.WURCS) }}>
                ...
                <svg className="h-6 w-6 mx-auto my-auto" xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
